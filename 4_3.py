...
spotify_autoencoder=joblib.load('../../models/autoencoder/4_2_autoencoder.joblib')
...
accuracy=accuracy_score(val_reduced['track_genre'].values,predicted_labels.astype(int))
macro_precision=precision_score(val_reduced['track_genre'].values,predicted_labels.astype(int),average='macro',zero_division=0)
macro_recall=recall_score(val_reduced['track_genre'].values,predicted_labels.astype(int),average='macro',zero_division=0)
macro_f1=f1_score(val_reduced['track_genre'].values,predicted_labels.astype(int),average='macro',zero_division=0)
micro_precision=precision_score(val_reduced['track_genre'].values,predicted_labels.astype(int),average='micro',zero_division=0)
micro_recall=recall_score(val_reduced['track_genre'].values,predicted_labels.astype(int),average='micro',zero_division=0)
micro_f1=f1_score(val_reduced['track_genre'].values,predicted_labels.astype(int),average='micro',zero_division=0)
